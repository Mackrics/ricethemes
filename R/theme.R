...
catppuccin_mocha_theme <- function(){
	theme <- theme(
				panel.background = element_rect(fill = catppuccin_mocha$Crust),
...
catppuccin_macchiato_theme <- function(){
	theme <- theme(
				panel.background = element_rect(fill = catppuccin_macchiato$Crust),
...
catppuccin_frappe_theme <- function(){
	theme <- theme(
				panel.background = element_rect(fill = catppuccin_frappe$Crust),
...
catppuccin_latte_theme <- function(){
	theme <- theme(
				panel.background = element_rect(fill = catppuccin_latte$Crust),
